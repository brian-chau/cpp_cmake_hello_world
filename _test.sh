...
# flags=-DRunningSum=ON
# flags=-DPivot=ON
# flags=-DHappyNumber=ON
# flags=-DTwoSum=ON
# flags=-DAnswerQuery=ON
...
lcov --capture --directory ./build/CMakeFiles/exe_test.dir/sources --output-file ./TestResults/main_coverage.info 1>/dev/null 2>&1
